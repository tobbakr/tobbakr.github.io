---
layout: single-page
title: "Schrijnwerker Boortmeerbeek, Leuven en Mechelen"
    ...
    <div class="row">
      {% for dienst in diensten_sorted %}
        <div class="col-xs-12 col-md-6 col-lg-4 mb-5">
          ...
          <a href="{{dienst.url}}" class="btn btn-outline-light btn-sm">Lees verder...</a>
        </div>
      {% endfor %}
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-5">
        ...
        <div class="mt-4 mb-3">
          <img src="{{ '/assets/img/oprichters.webp' | relative_url }}" alt="Kris Tobback en zijn vader in het atelier van Schrijnwerkerij Tobback" class="img-fluid rounded shadow-sm" width="640" height="640" loading="lazy">
