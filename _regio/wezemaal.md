  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8">
        ...
        <p>In Wezemaal hebben we onder andere een tuinhuis in western red cedar mogen realiseren dat naadloos past in de groene omgeving aan de Wijngaardberg. Van robuuste tuinhuizen en carports tot verfijnde binnendeuren en volledige interieurafwerkingen — elk project wordt op maat ontworpen en vervaardigd in ons eigen atelier. We starten steeds met een gratis huisbezoek waarin we uw wensen bespreken, de situatie ter plaatse bekijken en een vrijblijvende offerte opstellen.</p>
        ...
        <div class="faq-item mb-3">
          ...
          <p>In Wezemaal hebben we onder meer een ceder tuinhuis, houten raamkozijnen, maatwerk binnendeuren en interieurafwerkingen uitgevoerd. Bekijk onze realisaties hieronder voor een overzicht van recent afgewerkte projecten in de buurt.</p>
        </div>
        ...
        <a href="/contact/" class="btn btn-green btn-sm">Contacteer ons voor uw project in Wezemaal</a>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In Wezemaal hebben we onder meer een ceder tuinhuis, houten raamkozijnen, maatwerk binnendeuren en interieurafwerkingen uitgevoerd. Bekijk onze realisaties op de pagina voor een overzicht van recent afgewerkte projecten in de buurt."
      }
    },
    {
      "@type": "Question",
